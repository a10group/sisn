        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              >
                <TwitterIcon className="h-4 w-4 text-[#6366F1]" />
              ...
              <Link
                ...
                className="rounded-full bg-white p-2 hover:bg-white/90"
              >
                <InstagramIcon className="h-4 w-4 text-[#6366F1]" />
              ...
              <Link
                ...
                className="rounded-full bg-white p-2 hover:bg-white/90"
              >
                <LinkedinIcon className="h-4 w-4 text-[#6366F1]" />
              ...
              <Link
                ...
                className="rounded-full bg-white p-2 hover:bg-white/90"
              >
                <YoutubeIcon className="h-4 w-4 text-[#6366F1]" />
